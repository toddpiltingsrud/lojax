...
(function ($, jx) {
    ...
    $.extend(priv, {
        ...
        nonce: jQuery.now(),
        resolveAction: function resolveAction(params) {
            var action;
            ...
            else if (priv.hasValue(params.source) && priv.hasValue(params.source.href) && params.source.href.length && params.source.href.substr(0, 11) !== 'javascript:') {
